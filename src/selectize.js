...
$.extend(Selectize.prototype, {
    ...
    refreshOptions: function (triggerDropdown) {
        var i, j, k, n, groups, groups_order, option, option_html, optgroup, optgroups, html, html_children, has_create_option, parent, optgroups_tree, html_optgroup, root_optgroups_order, broke;
        ...
        optgroups_tree = {};
        var optgroups_rendered = {};
        root_optgroups_order = [];

        //We need to build tree
        for (i = 0, n = groups_order.length; i < n; i++) {
            ...
            if (self.optgroups.hasOwnProperty(optgroup) && groups[optgroup].childNodes.length) {
                ...
                optgroups_rendered[optgroup] = html_optgroup;

                parent = self.optgroups[optgroup][self.settings.optgroupParentField];

                broke = false;
                while (parent) {
                    if (optgroups_tree.hasOwnProperty(parent)) {
                        optgroups_tree[parent].appendChild(html_optgroup);
                        broke = true;
                        break;
                    }
                    if (!optgroups_rendered.hasOwnProperty(parent)) {
                        html_children = document.createDocumentFragment();
                        ...
                        optgroups_rendered[parent] = html_optgroup;
                    } else {
                        optgroups_rendered[parent].appendChild(html_optgroup);
                        broke = true;
                        break;
                    }
                ...
                if (!broke) {
                    if (parent) {
                        optgroups_tree[parent] = html_optgroup;
                        root_optgroups_order.push(html_optgroup);
                    } else {
                        optgroups_tree[optgroup] = html_optgroup;
                        root_optgroups_order.push(html_optgroup);
                    }
                }
